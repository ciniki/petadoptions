...
function ciniki_petadoptions_animalDelete(&$ciniki) {
    ...
    $rc = ciniki_petadoptions_checkAccess($ciniki, $args['business_id'], 'ciniki.petadoptions.animalDelete');
    if( $rc['stat'] != 'ok' ) {
        return $rc;
    }
    ...
    $rc = ciniki_core_objectCheckUsed($ciniki, $args['business_id'], 'ciniki.petadoptions.animal', $args['animal_id']);
    if( $rc['stat'] != 'ok' ) {
    ...
    // Remove the animal
    //
    $rc = ciniki_core_objectDelete($ciniki, $args['business_id'], 'ciniki.petadoptions.animal',
